...
def make_generator_model():
    model = saving.load_model("gen.keras")
    return model


def make_discriminator_model():
    model = saving.load_model("disc.keras")
    return model
...
generator_optimizer = tf.keras.optimizers.Adam(learning_rate=5e-4, beta_1=0.0, beta_2=0.9)
discriminator_optimizer = tf.keras.optimizers.Adam(learning_rate=5e-4, beta_1=0.0, beta_2=0.9)
